                    ...
                    <div class="card border-0 mt-5 flex-fill d-none" id="event">
                        ...
                        <div class="card-body px-1 py-3">
                            ...
                            <div class="input-group events-input mb-3 col-10 mx-auto mt-2">
                                <input type="text" class="form-control" placeholder="Креирај настан" id="eventTxt">
    ...
    $(function(){
        function showEvent(eventDate){
            ...
            if (storedEvents == null){
                $('.events-today').html('<h5 class="text-center">Немате креирано настан/и</h5 class="text-center">');               
            }else{
        ...
        function removeEvent(id){
            ...
            if(storedEvents != null){
                ...
                $('.toast-body').html('Вашиот настан е избришан');
                $('.toast').toast('show');
            }
        }        
        ...
        $(document).on('click', '#createEvent', function(){
            ...
            $('.error').remove();
            if (eventText == ''){
                $('.events-input').append(`<span class="error">Ве молиме внесете го настан</span>`);
                $('#eventTxt').addClass('data-invalid');
                $('#eventTxt').trigger('focus');
            }else if(eventText.length < 3){
                $('#eventTxt').addClass('data-invalid');
                $('#eventTxt').trigger('focus');
                $('.events-input').append(`<span class="error">Ве молиме внесете повеќе од 3 букви</span>`);
            }else{
                valid = true;
            }
            if (valid){
                ...
                $('#eventTxt').val('');
                $('.toast-body').html('Вашиот настан е креиран');
                $('.toast').toast('show');
                showEvent(eventDate);
            }
        })
